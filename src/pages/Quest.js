import preguntas from "../json/preguntas.js";
import { useState, useEffect } from "react";
import '../styles/Quest.css'

function Quest() {
  const [preguntaActual, setPreguntaActual] = useState(0);
  const [puntuación, setPuntuación] = useState(1);
    ...
    return (
      <main className="app">
        <div className="juego-terminado">
          ...
          <button className="questButton" onClick={() => (window.location.href = "/")}>
            {" "}
            Volver a jugar
          </button>
